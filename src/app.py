...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps and train for competitive events",
        "schedule": "Tuesdays and Fridays, 3:00 PM - 4:00 PM",
        "max_participants": 20,
    ...
    "Dance Workshop": {
        "description": "Learn dance routines and perform at school events",
